...
local MAJOR_VERSION = "Babbles-Spell-2.2"
local MINOR_VERSION = tonumber(string.sub("$Revision: 19518 $", 12, -3))
...
local BabblesSpell = AceLibrary("AceLocale-2.2"):new(MAJOR_VERSION)

-- uncomment below for debug information
-- BabblesSpell:EnableDebugging()

BabblesSpell:RegisterTranslations("enUS", function()
	return {
		...
		["Blessing of the Naaru"] = "Gift of the Naaru",
...
BabblesSpell:RegisterTranslations("deDE", function()
	return {
		...
		["Blessing of the Naaru"] = "Gabe der Naaru",
		...
		["Improved Magma Totem"] = "Verbessertes Totem des gl\195\188henden Magmas",
		...
		["Improved Rockbiter Weapon"] = "Verbesserte Waffe des Felsbei\195\159ers",
		...
		["Improved Windfury Weapon"] = "Verbesserte Waffe des Windzorns",
...
BabblesSpell:RegisterTranslations("frFR", function()
	return {
...
--		["Blazing Speed"] = true,
		...
		["Blessing of the Naaru"] = "Don des Naaru",
...
--		["Vampiric Touch"] = true,
		...
		["Water Walking"] = "Marche sur l\226\128\153eau",
...
BabblesSpell:RegisterTranslations("zhCN", function()
	return {
...
BabblesSpell:RegisterTranslations("zhTW", function()
	return {
...
BabblesSpell:RegisterTranslations("koKR", function()
	return {
...
BabblesSpell:Debug()
BabblesSpell:SetStrictness(true)

function BabblesSpell:GetSpellIcon(spell)
